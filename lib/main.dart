...
class _MyAppState extends State<MyApp> {
  ...
  var _uiImage2 = Image.asset('assets/portrait.png');
  ...
  clearResults() {
    ...
    livenessStatus = "nil";
    uiImage2 = Image.asset('assets/portrait.png');
  ...
  Widget textButton(String text, Function() onPressed, {ButtonStyle? style}) => TextButton(
        onPressed: onPressed,
        style: style,
        child: Text(text),
      );
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [text("Similarity: $_similarityStatus"), Container(margin: const EdgeInsets.fromLTRB(20, 0, 0, 0)), text("Liveness: $_livenessStatus")],
            )
          ],
        ),
      ),
